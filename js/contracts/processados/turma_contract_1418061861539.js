...
var TurmaContract = (function(Objetos) {
    ...
    return{
        ...
        setTurmaBase: function(objetoBase, objetoFront){
            ...
            if(objetoFront.curso || objetoFront.serie)
