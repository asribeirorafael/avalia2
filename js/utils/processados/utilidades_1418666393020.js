...
//                }
        ...
        enabledQuestions: function(){
            jQuery("#chkbx1").removeAttr('disabled');
            jQuery("#chkbx2").removeAttr('disabled');
            jQuery("#chkbx3").removeAttr('disabled');
            jQuery("#chkbx4").removeAttr('disabled');
            jQuery("#chkbx5").removeAttr('disabled');
