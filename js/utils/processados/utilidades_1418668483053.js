...
//                }
        ...
        disabledQuestions: function(){
            document.getElementById("chkbx1").disabled=true;
            document.getElementById("chkbx2").disabled=true;
            document.getElementById("chkbx3").disabled=true;
            document.getElementById("chkbx4").disabled=true;
            document.getElementById("chkbx5").disabled=true;
            document.getElementById("fecharAvaliacao").disabled=true;
        },

        enabledQuestions: function(){
            document.getElementById("chkbx1").disabled=false;
            document.getElementById("chkbx2").disabled=false;
            document.getElementById("chkbx3").disabled=false;
            document.getElementById("chkbx4").disabled=false;
            document.getElementById("chkbx5").disabled=false;
            document.getElementById("fecharAvaliacao").disabled=false;
        }
