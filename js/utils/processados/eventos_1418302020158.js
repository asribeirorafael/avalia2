...
provasApp.run(['$rootScope', '$compile', '$routeParams', function (escopoGlobal, compilador, paramRota) {
    ...
    escopoGlobal.escolas = new Array();
    escopoGlobal.turmas = new Array();
    escopoGlobal.alunos = new Array();
    escopoGlobal.professores = new Array();
    escopoGlobal.avaliacoes = new Array();
    escopoGlobal.totalAvaliacoes = new Array();
