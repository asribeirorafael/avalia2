...
//                }
        ...
        disabledQuestions: function(){
            jQuery("#chkbx1").attr('disabled', true);
            jQuery("#chkbx2").attr('disabled', true);
            jQuery("#chkbx3").attr('disabled', true);
            jQuery("#chkbx4").attr('disabled', true);
            jQuery("#chkbx5").attr('disabled', true);
            jQuery("#fecharAvaliacao").attr('disabled', true);
        },

        enabledQuestions: function(){
            jQuery("#chkbx1").attr('disabled', false);
            jQuery("#chkbx2").attr('disabled', false);
            jQuery("#chkbx3").attr('disabled', false);
            jQuery("#chkbx4").attr('disabled', false);
            jQuery("#chkbx5").attr('disabled', false);
            jQuery("#fecharAvaliacao").attr('disabled', false);
        }
