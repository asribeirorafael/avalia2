...
AvaliaControllers.controller("SelecionarAvaliacaoHipoteseController", ['$scope','$stateParams','$state', function($stateParams, $state){

    $state.get('avaliacaoHipotese').onEnter = function(){
        Utils.ReturnPersistData();
    ...
    $state.get('avaliacaoHipotese').onExit = function(){
        console.log("Sai da tela em que estava");
    };
